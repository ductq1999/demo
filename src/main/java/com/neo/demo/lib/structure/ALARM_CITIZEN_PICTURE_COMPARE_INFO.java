...
public class ALARM_CITIZEN_PICTURE_COMPARE_INFO extends NetSDKLib.SdkStructure {
     ...
     * 居民姓名
     */
    public byte[] szCitizen = new byte[NetSDKLib.NET_COMMON_STRING_64];
    /**
     * 住址
     */
    public byte[] szAddress = new byte[NetSDKLib.NET_COMMON_STRING_256];
    /**
     * 身份证号
     */
    public byte[] szNumber = new byte[NetSDKLib.NET_COMMON_STRING_64];
    /**
     * 签发机关
     */
    public byte[] szAuthority = new byte[NetSDKLib.NET_COMMON_STRING_256];
    /**
     * 出生日期(年月日)
     */
     ...
     * IC卡号
     */
    public byte[] szCardNo = new byte[NetSDKLib.NET_COMMON_STRING_32];
    /**
     * 手机号（比对时先输入手机号）
     */
    public byte[] szCellPhone = new byte[NetSDKLib.NET_COMMON_STRING_32];
    /**
    ...
    /**
     * 口罩状态 {@link NetSDKLib.EM_MASK_STATE_TYPE}
     */
    public int emMask;
    /**
     * 人脸质量评分
