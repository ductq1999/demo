...
public class DEV_EVENT_STREET_SUNCURE_INFO extends NetSDKLib.SdkStructure {
	 ...
	 * 规则检测区域
	 */
	public NetSDKLib.NET_POINT[] DetectRegion = new NetSDKLib.NET_POINT[NetSDKLib.NET_MAX_DETECT_REGION_NUM];
	 ...
	 * 检测到的物体
	 */
	public NetSDKLib.NET_MSG_OBJECT[] stuObjects = new NetSDKLib.NET_MSG_OBJECT[NetSDKLib.HDBJ_MAX_OBJECTS_NUM];
