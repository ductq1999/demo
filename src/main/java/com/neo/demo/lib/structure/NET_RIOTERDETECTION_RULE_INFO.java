...
import com.neo.demo.lib.NetSDKLib.SdkStructure;
...
public class NET_RIOTERDETECTION_RULE_INFO extends SdkStructure {
     ...
     * 检测区域
     */
    public  com.neo.demo.lib.structure.POINTCOORDINATE[]   stuDetectRegion=(com.neo.demo.lib.structure.POINTCOORDINATE[]) new com.neo.demo.lib.structure.POINTCOORDINATE().toArray(20);
    /**
     * 检测模式个数
     */
    public int                  nModeNum;
     ...
     */
    public  com.neo.demo.lib.structure.POINTCOORDINATE[]   stuMinDetectRect=(com.neo.demo.lib.structure.POINTCOORDINATE[]) new POINTCOORDINATE().toArray(2);
    /**
