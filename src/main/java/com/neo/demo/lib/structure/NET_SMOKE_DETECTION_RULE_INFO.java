...
import com.neo.demo.lib.enumeration.NET_EM_SCENEDETECTION_TYPE;
...
public class NET_SMOKE_DETECTION_RULE_INFO extends SdkStructure{
	 ...
	 * 检测区
	 */
	public com.neo.demo.lib.structure.POINTCOORDINATE[]				stuDetectRegion=(com.neo.demo.lib.structure.POINTCOORDINATE[])new POINTCOORDINATE().toArray(20);
	/**
	 * 最短持续时间,单位：秒 0~65535
	 */
