...
import com.neo.nbdapi.lib.enumeration.CFG_ACCESS_PROPERTY_TYPE;
...
public class CFG_ACCESS_GENERAL_INFO extends NetSDKLib.SdkStructure {
  /** 开门音频文件路径 */
  public byte[] szOpenDoorAudioPath = new byte[SDKStructureFieldLenth.MAX_ADDRESS_LEN];
  /** 关门音频文件路径 */
  public byte[] szCloseDoorAudioPath = new byte[SDKStructureFieldLenth.MAX_ADDRESS_LEN];
  /** 有人音频文件路径 */
  public byte[] szInUsedAuidoPath = new byte[SDKStructureFieldLenth.MAX_ADDRESS_LEN];
  /** 暂停使用音频文件路径 */
  public byte[] szPauseUsedAudioPath = new byte[SDKStructureFieldLenth.MAX_ADDRESS_LEN];
  /** 门未关音频文件路径 */
  public byte[] szNotClosedAudioPath = new byte[SDKStructureFieldLenth.MAX_ADDRESS_LEN];
  /** 等待提示音频文件路径 */
  public byte[] szWaitingAudioPath = new byte[SDKStructureFieldLenth.MAX_ADDRESS_LEN];
  ...
  /** 工程密码 */
  public byte[] szProjectPassword = new byte[SDKStructureFieldLenth.MAX_PASSWORD_LEN];
  /** 门禁通道单双向配置,对应枚举{@link CFG_ACCESS_PROPERTY_TYPE} */
  public int emAccessProperty;
  /** AB互锁信息 */
  public CFG_ABLOCK_INFO stuABLockInfo;
  /** 胁迫密码 */
  public byte[] szDuressPassword = new byte[SDKStructureFieldLenth.MAX_PASSWORD_LEN];
  /** 胁迫使能 */
  public boolean bDuressEnable;
  /** 是否启用个性化密码 */
  public boolean bCustomPasswordEnable;
  /** 公共密码 */
  public byte[] szCommonPassword = new byte[SDKStructureFieldLenth.MAX_PASSWORD_LEN];
