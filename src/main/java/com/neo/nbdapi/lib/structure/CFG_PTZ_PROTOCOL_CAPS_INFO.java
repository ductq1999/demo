...
import com.neo.nbdapi.lib.enumeration.EM_SUPPORT_FOCUS_MODE;

import static com.neo.nbdapi.lib.NetSDKLib.CFG_COMMON_STRING_32;
import static com.neo.nbdapi.lib.constant.SDKStructureFieldLenth.MAX_PROTOCOL_NAME_LEN;
...
public class CFG_PTZ_PROTOCOL_CAPS_INFO extends NetSDKLib.SdkStructure {
    ...
    /**
     * 支持的支持的焦距模式掩码,从低位到高位依次数,见{@link EM_SUPPORT_FOCUS_MODE}
     */
