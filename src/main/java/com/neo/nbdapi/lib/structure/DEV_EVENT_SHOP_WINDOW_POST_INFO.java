...
import com.neo.nbdapi.lib.enumeration.EM_EVENT_IVS_TYPE;

/**
 * @author 47081
 * @version 1.0
 * @description 事件类型
 * {@link EM_EVENT_IVS_TYPE#EVENT_IVS_SHOP_WINDOW_POST}(橱窗张贴事件)对应的数据块描述信息
 * @date 2020/11/16
 */
public class DEV_EVENT_SHOP_WINDOW_POST_INFO extends NetSDKLib.SdkStructure {
     ...
     * 检测区域
     */
    public NetSDKLib.NET_POINT[] stuDetectRegion = (NetSDKLib.NET_POINT[]) new NetSDKLib.NET_POINT().toArray(SDKStructureFieldLenth.SDK_MAX_DETECT_REGION_NUM);
    /**
     * 检测到的物体个数
     */
     ...
     * 检测到的物体
     */
    public NetSDKLib.NET_MSG_OBJECT[] stuObjects = (NetSDKLib.NET_MSG_OBJECT[]) new NetSDKLib.NET_MSG_OBJECT().toArray(NetSDKLib.HDBJ_MAX_OBJECTS_NUM);
    /**
     * 事件触发的预置点号，从1开始
     */
