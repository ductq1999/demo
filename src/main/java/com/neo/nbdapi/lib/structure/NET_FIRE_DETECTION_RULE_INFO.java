...
import com.neo.nbdapi.lib.enumeration.NET_EM_SCENEDETECTION_TYPE;
...
public class NET_FIRE_DETECTION_RULE_INFO extends SdkStructure{
	 ...
	 * 检测区
	 */
	public com.neo.nbdapi.lib.structure.POINTCOORDINATE[]				stuDetectRegion=(com.neo.nbdapi.lib.structure.POINTCOORDINATE[])new POINTCOORDINATE().toArray(20);
	/**
	 * 最短持续时间,单位：秒 0~65535
	 */
