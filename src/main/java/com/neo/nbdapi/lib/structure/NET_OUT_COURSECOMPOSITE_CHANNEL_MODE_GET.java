...
public class NET_OUT_COURSECOMPOSITE_CHANNEL_MODE_GET extends NetSDKLib.SdkStructure {
     ...
     * 模式编号
     */
    public int[] nMode = new int[NetSDKLib.NET_MAX_MODE_NUMBER];
    /**
     * 模式信息
     */
    public NET_COMPOSITECHANNELMODE_INFO[] stModeInfo = new NET_COMPOSITECHANNELMODE_INFO[NetSDKLib.NET_MAX_MODE_NUMBER];
