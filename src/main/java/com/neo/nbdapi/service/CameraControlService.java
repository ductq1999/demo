package com.neo.nbdapi.service;
...
public class CameraControlService {
     ...
     * 向左
     */
    public boolean ptzControlLeftStart(int nChannelID, int lParam1, int lParam2) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_PTZ_ControlType.NET_PTZ_LEFT_CONTROL,
                lParam1, lParam2, 0, 0);
    }
    public boolean ptzControlLeftEnd(int nChannelID) {
        return	CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_PTZ_ControlType.NET_PTZ_LEFT_CONTROL,
                0, 0, 0, 1);
    }
     ...
     * 向右
     */
    public boolean ptzControlRightStart(int nChannelID, int lParam1,int lParam2) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_PTZ_ControlType.NET_PTZ_RIGHT_CONTROL,
                lParam1, lParam2, 0, 0);
    }
    public boolean ptzControlRightEnd(int nChannelID) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_PTZ_ControlType.NET_PTZ_RIGHT_CONTROL,
                0, 0, 0, 1);
    }
     ...
     * 向左上
     */
    public boolean ptzControlLeftUpStart(int nChannelID, int lParam1, int lParam2) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_EXTPTZ_ControlType.NET_EXTPTZ_LEFTTOP,
                lParam1, lParam2, 0, 0);
    }
    public boolean ptzControlLeftUpEnd(int nChannelID) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_EXTPTZ_ControlType.NET_EXTPTZ_LEFTTOP,
                0, 0, 0, 1);
    }
     ...
     * @param nChannelID
     */
    public boolean ptzControlRightUpStart(int nChannelID, int lParam1, int lParam2) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_EXTPTZ_ControlType.NET_EXTPTZ_RIGHTTOP,
                lParam1, lParam2, 0, 0);
    }
    public boolean ptzControlRightUpEnd(int nChannelID) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_EXTPTZ_ControlType.NET_EXTPTZ_RIGHTTOP,
                0, 0, 0, 1);
    }
     ...
     * 向左下
     */
    public boolean ptzControlLeftDownStart(int nChannelID, int lParam1, int lParam2) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_EXTPTZ_ControlType.NET_EXTPTZ_LEFTDOWN,
                lParam1, lParam2, 0, 0);
    }
    public boolean ptzControlLeftDownEnd(int nChannelID) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_EXTPTZ_ControlType.NET_EXTPTZ_LEFTDOWN,
                0, 0, 0, 1);
    }
     ...
     * 向右下
     */
    public boolean ptzControlRightDownStart(int nChannelID, int lParam1, int lParam2) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_EXTPTZ_ControlType.NET_EXTPTZ_RIGHTDOWN,
                lParam1, lParam2, 0, 0);
    }
    public boolean ptzControlRightDownEnd(int nChannelID) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_EXTPTZ_ControlType.NET_EXTPTZ_RIGHTDOWN,
                0, 0, 0, 1);
    }
     ...
     * 变倍+
     */
    public boolean ptzControlZoomAddStart(int nChannelID, int lParam2) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_PTZ_ControlType.NET_PTZ_ZOOM_ADD_CONTROL,
                0, lParam2, 0, 0);
    }
    public boolean ptzControlZoomAddEnd(int nChannelID) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_PTZ_ControlType.NET_PTZ_ZOOM_ADD_CONTROL,
                0, 0, 0, 1);
    }
     ...
     * 变倍-
     */
    public boolean ptzControlZoomDecStart(int nChannelID, int lParam2) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_PTZ_ControlType.NET_PTZ_ZOOM_DEC_CONTROL,
                0, lParam2, 0, 0);
    }
    public boolean ptzControlZoomDecEnd(int nChannelID) {
        return CameraLoginService.netsdk.CLIENT_DHPTZControlEx(CameraLoginService.m_hLoginHandle, nChannelID,
                NetSDKLib.NET_PTZ_ControlType.NET_PTZ_ZOOM_DEC_CONTROL,
                0, 0, 0, 1);
    }
